...
const PRICE_LABEL: Record<string, string> = {
  ...
  strategist: 'border border-amber-400/60 dark:border-amber-500/50 text-amber-700 dark:text-amber-300',
}
...
const TAG_BADGE: Record<string, string> = {
  ...
  strategist: 'bg-amber-100/60 dark:bg-amber-900/30 border-amber-200/60 dark:border-amber-700/40 text-amber-800 dark:text-amber-300',
}
...
export function ResearchCard({ research }: ResearchCardProps) {
  ...
  return (
    ...
    >
      {/* 왼쪽 투자의견 액센트 스트립 — AI·Strategist 동일 */}
      <div
        className={cn(
