...
export default async function StrategistPage({ searchParams }: StrategistPageProps) {
  ...
  const allResearches = getMockResearches('strategist')
  ...
  return (
    <div className='mx-auto w-full max-w-3xl px-4 py-8'>
      <div className='mb-8'>
        <h1 className='text-2xl font-bold tracking-tight'>Strategist Research</h1>
        <p className='text-sm text-muted-foreground mt-1'>
          전문가 전략가의 종목 분석 및 매수 추천 아카이브
        </p>
      </div>
